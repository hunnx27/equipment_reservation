package com.twodollar.modules.admin.menu.application;

import com.twodollar.common.exception.CustomException;
import com.twodollar.common.web.ApiR;
import com.twodollar.modules.admin.menu.domain.Menu;
import com.twodollar.modules.admin.menu.infra.MenuRepository;
import com.twodollar.modules.admin.menu.web.dto.response.MenuSelectResponseDto;
...
import static com.twodollar.common.web.dto.response.enums.ErrorCode.DUPLICATE_RESOURCE;
import static com.twodollar.common.web.dto.response.enums.ErrorCode.NOT_ACCEPTABLE;
